...
const certifications = [
  // CIBERSEGURIDAD & DEFENSA
  {
    ...
    type: 'Ciberseguridad',
    fileUrl:
      '/diplomas/Junior Cybersecurity Analyst Career Path certificate.pdf',
  },
  {
    ...
    status: 'Verified',
    type: 'Ciberseguridad',
    fileUrl: '/diplomas/Ethical Hacker.jpg',
  },
  {
    ...
    type: 'Ciberseguridad',
    fileUrl:
      '/diplomas/Network_Defense_certificate_josemanuelsuarez110-icloud-com_fe1fef07-3b59-4ebd-9350-c05f645ad47f.pdf',
  },
  {
    ...
    status: 'Verified',
    type: 'Ciberseguridad',
    fileUrl: '/diplomas/Endpoint Security.png',
  },
  {
    ...
    status: 'Expert',
    type: 'Ciberseguridad',
    fileUrl: '/diplomas/Cyber Threat Management Certificate.pdf',
  },
  {
    title: 'ISC2 CC - Domain 1',
    issuer: 'ISC2',
    status: 'Security Principles',
    type: 'Ciberseguridad',
    fileUrl: '/diplomas/CC DOMAIN 1.pdf',
  },
  {
    ...
    status: 'Auditoría',
    type: 'Ciberseguridad',
    fileUrl: '/diplomas/implementacion y auditoria iso 27001_1.jpg',
  },
  {
    ...
    status: 'Foundations',
    type: 'Ciberseguridad',
    fileUrl: '/diplomas/introduction-to-cybersecurity (1).png',
  },
  ...
  // INGENIERÍA DE SOFTWARE & INFRAESTRUCTURA
  {
    ...
    status: 'Avanzado',
    type: 'Sistemas',
    fileUrl: '/diplomas/Python Essentials 2.pdf',
  },
  {
    ...
    status: 'Certified',
    type: 'Sistemas',
    fileUrl: '/diplomas/Python_Essentials_1.jpg',
  },
  {
    ...
    type: 'Sistemas',
    fileUrl:
      '/diplomas/Linux_Essentials_certificate_josemanuelsuarez110-icloud-com_f98b1fbc-35db-4999-a2e8-c700312e42ef.pdf',
  },
  {
    ...
    status: 'Verified',
    type: 'Sistemas',
    fileUrl: '/diplomas/Linux Unhatched certificate.pdf',
  },
  {
    ...
    status: 'Certified',
    type: 'Sistemas',
    fileUrl: '/diplomas/Networking_Basics_certificate_.jpg',
  },
  {
    ...
    status: 'Verified',
    type: 'Sistemas',
    fileUrl: '/diplomas/Networking Devices and Initial Configuration.png',
  },
  {
    ...
    type: 'Sistemas',
    fileUrl:
      '/diplomas/IT_Customer_Support_Basics_certificate_josemanuelsuarez110-icloud-com_336a0cf3-491d-405c-8f4c-a227416d9504.pdf',
  },
  ...
  // FINANZAS & GESTIÓN
  {
    ...
    status: 'Experto',
    type: 'Finanzas',
    fileUrl: '/diplomas/Administración del Inventario_1.jpg',
  },
  {
    title: 'Flujo de Caja',
    issuer: 'HP LIFE Foundation',
    status: 'Análisis Financiero',
    type: 'Finanzas',
    fileUrl: '/diplomas/Flujo de Caja_1.jpg',
  },

  // FORMACIÓN ACADÉMICA
  {
    title: 'Ingeniero en Sistemas de Información',
    issuer: 'Universidad APEC',
    status: 'Graduado',
    type: 'Academia',
    fileUrl: '/diplomas/universidad_apec.pdf',
  },
  {
    title: 'Licenciatura en Contabilidad',
    issuer: 'Universidad Federico Henríquez y Carvajal',
    status: 'Suma Cum Laude',
    type: 'Academia',
  },
]
      ...
      <Reveal>
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400 max-w-xl mx-auto italic">
            "La autoridad técnica no se presume, se verifica." — Una
            trayectoria de excelencia ininterrumpida con más de 40
