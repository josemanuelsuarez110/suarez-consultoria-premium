...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -right-40 bottom-0 h-[600px] w-[600px] rounded-full bg-emerald-500/10 blur-[140px]" />

      {/* Decorative lines */}
      <motion.div
        animate={{ y: [0, 20, 0] }}
        transition={{ duration: 7, repeat: Infinity, ease: 'easeInOut' }}
        className="absolute right-[12%] top-[20%] hidden h-40 w-px bg-gradient-to-b from-transparent via-cyan-400/40 to-transparent lg:block"
      />

      <motion.div
        animate={{ y: [0, -25, 0] }}
        transition={{ duration: 9, repeat: Infinity, ease: 'easeInOut' }}
        className="absolute left-[8%] bottom-[20%] hidden h-32 w-px bg-gradient-to-b from-transparent via-emerald-400/30 to-transparent lg:block"
      />
            ...
            <div>
              <Reveal>
                <div className="mb-7 flex flex-wrap items-center gap-3">
                  <span className="inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/5 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.22em] text-cyan-300 backdrop-blur-xl">
              ...
              <Reveal delay={0.28}>
                <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                  <button
                    ...
                    className="group inline-flex items-center justify-center gap-3 rounded-xl bg-cyan-400 px-7 py-4 text-sm font-black uppercase tracking-wider text-slate-950 transition-all duration-300 hover:scale-[1.03] hover:bg-cyan-300 hover:shadow-[0_0_45px_rgba(34,211,238,0.25)]"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/[0.03] px-7 py-4 text-sm font-bold uppercase tracking-wider text-white backdrop-blur-xl transition-all duration-300 hover:border-cyan-400/30 hover:bg-white/[0.06]"
                  >
                    Ver credenciales
            ...
            <Reveal delay={0.25}>
              <div className="relative mx-auto w-full max-w-[580px]">
                ...
                <motion.div
                  ...
                  className="absolute -inset-8 rounded-full border border-cyan-400/10 border-dashed"
                />
                ...
                <motion.div
                  ...
                  className="absolute -inset-16 rounded-full border border-emerald-400/[0.08]"
                />
                ...
                <div className="relative overflow-hidden rounded-[30px] border border-white/10 bg-slate-900/70 p-3 shadow-2xl backdrop-blur-xl">
                  <div className="relative aspect-[4/5] overflow-hidden rounded-[22px]">
                    ...
                    <motion.div
                      ...
                      className="absolute left-0 top-0 h-px w-full bg-cyan-300/40 shadow-[0_0_15px_rgba(34,211,238,0.8)]"
                    />

                    {/* Image label */}
                    <div className="absolute left-5 top-5 flex items-center gap-2 rounded-lg border border-white/10 bg-black/30 px-3 py-2 font-mono text-[9px] uppercase tracking-[0.2em] text-cyan-300 backdrop-blur-md">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6">
                      <div className="flex items-end justify-between gap-4">
                        <div>
                          <p className="font-mono text-[9px] uppercase tracking-[0.25em] text-cyan-300">
                            SYSTEMS ENGINEER
                          </p>
                        ...
                        <div className="hidden rounded-lg border border-emerald-400/20 bg-emerald-400/10 px-3 py-2 text-right sm:block">
                ...
                <button
                  onClick={() => scrollTo('credentials')}
                  className="absolute -bottom-5 -right-5 hidden h-14 w-14 items-center justify-center rounded-full border border-white/10 bg-slate-900 text-slate-400 shadow-xl transition-colors hover:border-cyan-400/30 hover:text-cyan-300 sm:flex"
